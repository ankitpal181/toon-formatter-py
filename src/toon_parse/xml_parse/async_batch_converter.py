...
class AsyncBatchXmlConverter:
    ...
    @async_batch_modulator
    async def to_toon(self, xml_data: list[str] | str, conversion_mode: Literal[
        "no_encryption", "middleware", "ingestion", "export"
    ] = "no_encryption"):
        """
    ...
    @async_batch_modulator
    async def to_json(self, xml_data: list[str] | str, conversion_mode: Literal[
        "no_encryption", "middleware", "ingestion", "export"
    ] = "no_encryption"):
        """
    ...
    @async_batch_modulator
    async def to_yaml(self, xml_data: list[str] | str, conversion_mode: Literal[
        "no_encryption", "middleware", "ingestion", "export"
    ] = "no_encryption"):
        """
    ...
    @async_batch_modulator
    async def to_csv(self, xml_data: list[str] | str, conversion_mode: Literal[
        "no_encryption", "middleware", "ingestion", "export"
    ] = "no_encryption"):
        """
    ...
    @staticmethod
    async def validate(xml_data: list[str] | str):
        """
        ...
        if isinstance(xml_data, str):
            content = await loop.run_in_executor(None, lambda: open(xml_data, "r").read())
            return await loop.run_in_executor(None, validate_xml_string, content)
        else:
            return await asyncio.gather(*[loop.run_in_executor(None, validate_xml_string, datum) for datum in xml_data])
